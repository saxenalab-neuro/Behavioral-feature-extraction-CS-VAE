...
def train():
    ...
    history1 =allmodel.fit( data_generator.DataGenerator(hdf5file=hdf5_file,image_name=image_name, dim=(img_x,img_y), n_channels=img_z,n_labs=sdim,label_name=label_name,batch_size=batch_size, if_train=True),validation_data=data_generator.DataGenerator(hdf5file=hdf5_file, image_name=image_name, dim=(img_x,img_y), n_channels=img_z,n_labs=sdim,label_name=label_name,batch_size=batch_size, if_train=True),
